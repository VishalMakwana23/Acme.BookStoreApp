...
public class BookStoreAppDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public BookStoreAppDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
